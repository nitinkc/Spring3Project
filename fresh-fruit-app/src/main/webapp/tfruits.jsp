...
<%-- <span style="float: right;margin-right: 150px;">
      ${fruitPaginationForm.currentPage} Of ${fruitPaginationForm.noOfPages} Pages - ${fruitPaginationForm.noOfRecords} Records 
     </span>
 --%>     
   ...
   <br>
	<table class="table table-bordered"
		...
		<tbody id="tbodyContent">
			...
			<c:forEach items="${fruitPaginationForm.fruitFormList}" var="item" varStatus="var">
				<tr>
					<td>${var.count}</td>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;
       ...
       <a href="#"  id="previous" pageNo="${fruitPaginationForm.currentPage - 1}" style=" text-decoration: none !important; color: black !important; cursor: default;">Previous</a>
        &nbsp;&nbsp; | &nbsp;&nbsp;
        <c:if test="${fruitPaginationForm.currentPage lt fruitPaginationForm.noOfPages}">
          <a href="#" id="next"   pageNo="${fruitPaginationForm.currentPage + 1}">Next</a>
        </c:if>
